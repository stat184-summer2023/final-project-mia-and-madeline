...
X (A) .Rmd Line number(s) for general data wrangling: 


X (B) .Rmd Line number(s) for a join operation: 


X (C) .Rmd Line number(s) for use of reduction and/or transformation functions:
