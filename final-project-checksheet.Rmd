...
X (A) .Rmd Line number(s) for use of multiple different geoms on a single plot:  

X (B) .Rmd Line number(s) for use of multiple aesthetics:  

X (C) .Rmd Line number(s) for use of layered graphics:  
