...
climate %>% 
  left_join(population) %>%
  na.omit() %>%
  ggplot(aes(x = GrowthRate)) + geom_density(aes(colour = climate))  + # create density plot
...
Overall, there is a positive correlation between sunshine and population growth rate and climate. However, moderate climates have a stronger, more positive correlation with population growth rates than tropical climates. This can lead to further research and study on why tropical locations are generally less attractive to people. 
