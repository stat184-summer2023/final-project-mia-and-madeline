...
- The *sunshine* data has 392 cases of individual cities across the world and the total number of sunshine hours they get per month. The data also contains the country each city resides in and the total number of hours of sunshine per year. This data was found on Kaggle (https://www.kaggle.com/datasets/bilalwaseer/sunshine-hours-for-cities-around-the-world) and was published by *Muhammad Bilal Hussain* at the beggining of 2023. 
```{r}
